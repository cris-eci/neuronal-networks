...
```
neuronal-networks/
├── cnn_assignment.ipynb              # Your completed notebook
├── model.tar.gz                      # Packaged model for SageMaker
├── cifar10_cnn_model/                # Saved Keras model directory
│   ├── saved_model.pb
│   ├── variables/
│   └── ...
└── sagemaker_scripts/
...
```
======================================================================
🚀 CIFAR-10 CNN MODEL - SAGEMAKER DEPLOYMENT
======================================================================
...
📤 Step 2: Uploading model.tar.gz to S3...
   ✅ S3 Path: s3://sagemaker-us-east-1-XXXX/cifar10-cnn-model/model.tar.gz

🔧 Step 3: Creating SageMaker TensorFlow Model object...
   ✅ TensorFlow Model object created successfully

🌐 Step 4: Deploying endpoint...
   --------------------------------------------------
   📋 Endpoint Name:    cifar10-cnn-endpoint
   📋 Instance Type:    ml.m5.large
   📋 Instance Count:   1
   📋 Framework:        TensorFlow 2.13
   --------------------------------------------------

   ❌ Endpoint deployment failed: (IAM restriction - expected in Learner Lab)

🧪 Running LOCAL inference test...
--------------------------------------------------
   ✅ Model loaded: Custom_CNN
...
======================================================================
📊 DEPLOYMENT DEMO COMPLETE (with local fallback)
======================================================================
...
📊 Summary:
   ...
   │ SageMaker TensorFlow Model object        │   ✅   │
